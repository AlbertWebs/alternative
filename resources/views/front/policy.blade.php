   ...
   <div class="rs-breadcrumbs img1">
    <div class="container">
        <div class="breadcrumbs-inner">
            <h1 class="page-title">
                Privacy Policy
                <span class="watermark">Data USE</span>
            </h1>
            <span class="sub-text">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="card-link" href="#" data-bs-toggle="collapse"
                                    data-bs-target="#collapseOne" aria-expanded="true">Privacy Policy</a>
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Alizhora HR International, Namgoi Road, off Eldoret-Kitale Rd, Kitale.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                <p><strong>Website</strong> refers to Alizhora HR International, accessible from <a href="https://www.alizhorahrinternational.co.ke" target="_blank">https://www.alizhorahrinternational.co.ke</a></p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                <p>By email: hello@alizhorahrinternational.co.ke</p>
                                </li>
                                <li>
                                <p>By visiting this page on our website: <a href="https://alizhorahrinternational.co.ke/contact-us" target="_blank">https://alizhorahrinternational.co.ke/contact-us</a></p>
                                </li>
                            </ul>
                                            <p></p>
