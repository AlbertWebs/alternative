...
@section('content')
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-6 col-md-12">
						<div class="banner-image">
							<img src="{{asset('uploads/50928516-9eb5-4fb0-98a3-6b8baabdc48d.jfif')}}" alt="image">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-img">
                            <br>
							<img class="radius-10" src="{{url('/')}}/uploads/055c8665-21bc-4224-b93d-cd4db3bbd5c0.jpeg" alt="Image">
						</div>
					</div>
	   ...
	   {{-- @include('front.homespage-section') --}}
